...
const SignupPage = () => {
  ...
  const handleSignup = () => {
    // Validation
    if (!formData.fullName || !formData.email || !formData.phone || !formData.location || !formData.password || !formData.confirmPassword) {
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
            <h2 className="text-2xl font-bold text-center">Join HostelKart</h2>
            <p className="text-center text-blue-100 mt-1">Create your account today</p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-gray-50 border border-gray-300 rounded focus:ring-blue-500 focus:ring-2 mt-1"
                />
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>© 2025 HostelKart. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
